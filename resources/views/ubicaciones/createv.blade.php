    ...
    <div class="card shadow">
        <div class="card-header border-0">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="mb-0">Registro de ubicacion para el {{$user->rol}} {{$user->name}}</h3>
                </div>
        ...
        <div class="card-body">
            @if ($errors->any())
                ...
                @endforeach
            @endif
            <form action="{{ url('/ubicaciones/vendedores') }}" method="POST">
                @csrf
                <div class="form-group">
                    <label for="latitud">Latitud</label>
                    <input type="text" name="latitud" class="form-control" value="{{ old('latitud') }}" id="latitud"
                        required>
                </div>
                <div class="form-group">
